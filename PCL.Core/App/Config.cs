...
public static partial class Config
{
    ...
    [ConfigGroup("Preference")] partial class PreferenceConfigGroup
    {
        ...
        [ConfigGroup("Theme")] partial class ThemeConfigGroup
        {
            ...
            /// 自定义主题：饱和度 (S)。
            /// </summary>
            [ConfigItem<int>("UiLauncherSat", 100, ConfigSource.Local)] public partial int WindowSat { get; set; }

            /// <summary>
            /// 自定义主题：明度 (L)。
            /// </summary>
            [ConfigItem<int>("UiLauncherLight", 100, ConfigSource.Local)] public partial int WindowLight { get; set; }
