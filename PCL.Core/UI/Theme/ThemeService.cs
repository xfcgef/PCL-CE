...
public sealed partial class ThemeService
{
    ...
    public static (int Hue, double LightAdjust, double ChromaAdjust) GetCurrentThemeArgs()
    {
        ...
        return theme switch
        {
            ...
            (ColorTheme)3 => (
                Config.Preference.Theme.WindowHue, 
                Config.Preference.Theme.WindowLight <= 100 ? (Config.Preference.Theme.WindowLight - 100) / 100.0 : (Config.Preference.Theme.WindowLight - 100) / 300.0,
                Config.Preference.Theme.WindowSat <= 100 ? (Config.Preference.Theme.WindowSat - 100) / 100.0 : (Config.Preference.Theme.WindowSat - 100) / 300.0
            ),
#if DEBUG
            _ => ((int)theme, 0, 0)
#else
