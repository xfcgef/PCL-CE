...
#Region "页面切换"
    ...
    ''' 勾选事件改变页面。
    ''' </summary>
    Private Sub PageCheck(sender As MyListItem, e As RouteEventArgs) Handles ItemInstall.Check, ItemMod.Check, ItemPack.Check, ItemDataPack.Check, ItemResourcePack.Check, ItemShader.Check, ItemWorld.Check, ItemFavorites.Check
