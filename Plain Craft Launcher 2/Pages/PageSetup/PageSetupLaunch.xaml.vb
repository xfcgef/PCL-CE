...
Public Class PageSetupLaunch
    ...
    Public Sub Reload()
        Try
            ...
            CheckAdvanceDisableLwjglUnsafeAgent.Checked = Setup.Get("LaunchAdvanceDisableLwjglUnsafeAgent")
    ...
    End Sub
    Private Shared Sub TextBoxChange(sender As MyTextBox, e As Object) Handles TextArgumentWindowHeight.ValidatedTextChanged, TextArgumentWindowWidth.ValidatedTextChanged, TextArgumentInfo.ValidatedTextChanged, TextAdvanceGame.ValidatedTextChanged, TextAdvanceJvm.ValidatedTextChanged, TextArgumentTitle.TextChanged, TextAdvanceRun.ValidatedTextChanged
    ...
    End Sub
    Private Shared Sub CheckBoxChange(sender As MyCheckBox, e As Object) Handles CheckAdvanceRunWait.Change, CheckArgumentRam.Change, CheckAdvanceDisableJLW.Change, CheckAdvanceGraphicCard.Change, CheckAdvanceDisableRW.Change, CheckAdvanceNoJavaw.Change, CheckAdvanceDisableLwjglUnsafeAgent.Change
