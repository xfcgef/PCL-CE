PCL CE NoMoreBlue 是基于PCL CE制作的修改版，添加自定义功能（需要确认），无法保证与上游的同步更新或修复bug。

在任何情况下不推荐使用本版本。本软件按“原样”提供，不做任何承诺或保证，可能随时删库。

**使用自定义配色即代表你同意将所选色相视为蓝色，否则请使用官方快照版。**

如果你认为本软件侵犯了你的权益，请联系stevenzh2077@gmail.com，我们会第一时间处理。
